...
En el mapa se repite una escena pixel art de 31 segundos: Eduardo y Álvaro esperan en el centro durante 10 segundos; después Dario y Mini Sama entran por la derecha, animan su pose frontal y muestran un bocadillo durante 5 segundos; por último los cuatro corren hacia la izquierda y vuelven hacia la derecha hasta salir de la pantalla. Eduardo y Álvaro usan atlas propios de 4 × 2 celdas: una pose frontal y siete pasos de carrera hacia la derecha; la carrera hacia la izquierda reutiliza esos pasos reflejados. Dario y Mini Sama usan sus atlas originales de Codex Pets (8 × 9 celdas, 192 × 208 píxeles por celda), con filas específicas para reposo, carrera a la derecha y carrera a la izquierda. `src/PixelCameo.jsx` selecciona los fotogramas y coloca los personajes; `src/styles.css` define su presentación. La escena se omite si el sistema solicita movimiento reducido. Los atlas de los presentadores se generaron a partir de sus retratos de `public/presenters/`.

Los atlas originales de las mascotas se obtuvieron de [Dario](https://codex-pets.net/#/pets/dario) y [Mini Sama](https://codex-pets.net/#/pets/mini-sama) en Codex Pets. La ficha de Mini Sama atribuye la creación a NotOnKetamine; la de Dario muestra el identificador `user-6bb09cf5`. Se guardan localmente en `public/presenters/` para que la animación no dependa de una petición al catálogo durante la presentación.
